...
def dark(x):
  ...
  if stay_place == "stay":
    ...
    winsound.PlaySound("dark_scream_dead.wav", winsound.SND_ASYNC) #scream
...
def possibility(stay_place):
  ...
  winsound.PlaySound("dark_ominous_music.wav", winsound.SND_ASYNC) #ominous music
...
def squeeze_through(open_door):
  ...
  winsound.PlaySound("dark_nightmare.wav", winsound.SND_ASYNC) #roars of rage
  ...
  if shadow_progressing == "face it":
    os.startfile('dark_monster.jpg') #monster
    winsound.PlaySound("dark_breathing.wav", winsound.SND_ASYNC) #heavy breathing
...
def run_away(shadow_progressing):
  ...
  os.startfile('dark_corner.jpg') #in corner
  ...
  winsound.PlaySound("dark_hiding.wav", winsound.SND_ASYNC) #muffled breathing
  ...
  os.startfile('dark_mirrors.jpg') #distressed in mirrors
